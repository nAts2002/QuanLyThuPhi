...
public class HoKhauController implements Initializable {
    ...
    public void tachHoKhau() throws ClassNotFoundException, SQLException, IOException {
        Parent home = FXMLLoader.load(getClass().getResource("/views/hokhau/TachHoKhau.fxml"));
        Stage stage = new Stage();
        stage.setScene(new Scene(home, 1000, 600));
        stage.setResizable(false);
        stage.showAndWait();
        showHoKhau();
    }
