...
public class KhoanThuController implements Initializable {
    ...
    @FXML
    private TableColumn<KhoanThuModel, String> colHanNop;
    @FXML
    ...
    public void showKhoanThu() throws ClassNotFoundException, SQLException {
        ...
        colHanNop.setCellValueFactory(new PropertyValueFactory<KhoanThuModel, String>("hanNop"));
        Map<Integer, String> mapLoaiKhoanThu = new TreeMap();
        mapLoaiKhoanThu.put(1, "Bắt buộc");
        mapLoaiKhoanThu.put(0, "Tự nguyện");

//        Map<Date, String> mapDateToString = new HashMap<>();
//        List<KhoanThuModel> listkhoanthu = new KhoanThuService().getListKhoanThu();
//        listkhoanthu.forEach(nhankhau -> {
//            mapDateToString.put(nhankhau.getHanNop(), nhankhau.getHanNop().toString());
//        });
